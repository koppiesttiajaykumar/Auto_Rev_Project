...
public class TestResult {
    ...
    private String automationOwner; // [NEW] Naya variable database mapping ke liye
    ...
    // [NEW] AutomationOwner ke liye Getter method
    public String getAutomationOwner() { return automationOwner; }
    
    // [NEW] AutomationOwner ke liye Setter method
    public void setAutomationOwner(String automationOwner) { this.automationOwner = automationOwner; }
}
